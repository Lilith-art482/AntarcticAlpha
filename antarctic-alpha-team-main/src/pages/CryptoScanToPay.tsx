      ...
      <div className={`relative overflow-hidden rounded-3xl border ${
        ...
        <div className="relative p-8 text-center">
          ...
          <div className={`w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center ${
            ...
            <QrCode className="w-8 h-8 text-[#4C7F6E]" />
          </div>

          <h1 className={`text-2xl font-black mb-2 ${
            theme === 'dark' ? 'text-white' : 'text-gray-900'
          }`}>
            Crypto <span className="text-[#4C7F6E]">Scan-to-Pay</span>
          </h1>
          ...
          <div className={`p-4 rounded-2xl ${
            ...
            <p className={`text-sm leading-relaxed ${
              ...
              Оплата криптовалютой через <span className="font-bold text-[#4C7F6E]">QR-код по системе СБП</span>. 
              Сканируйте и оплачивайте покупки мгновенно.
            </p>
          </div>
...
export default CryptoScanToPay
