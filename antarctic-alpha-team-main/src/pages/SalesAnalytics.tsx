      ...
      <div className={`relative overflow-hidden rounded-3xl border ${
        ...
        <div className="relative p-8 text-center">
          ...
          <div className={`w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center ${
            ...
            <TrendingUp className="w-8 h-8 text-[#4C7F6E]" />
          </div>

          <h1 className={`text-2xl font-black mb-2 ${
            theme === 'dark' ? 'text-white' : 'text-gray-900'
          }`}>
            <span className="text-[#4C7F6E]">Sales</span> Analytics
          </h1>
          ...
          <div className={`p-4 rounded-2xl ${
            ...
            <p className={`text-sm leading-relaxed ${
              ...
              Аналитика по <span className="font-bold text-[#4C7F6E]">продажам курсов и продуктов</span> сообщества. Выручка, популярные продукты и эффективность.
            </p>
          </div>
