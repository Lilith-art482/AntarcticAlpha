...
export const CustomSelect: React.FC<CustomSelectProps> = ({
    ...
    return (
        <div className="relative min-w-[180px]" ref={containerRef}>
            ...
            {isOpen && (
                <div className={`absolute z-[100] top-full mt-2 w-full min-w-[200px] rounded-2xl border shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 ${theme === 'dark' ? 'bg-[#1a1f26] border-white/10' : 'bg-white border-gray-200'
                    }`}>
                    {searchable && (
