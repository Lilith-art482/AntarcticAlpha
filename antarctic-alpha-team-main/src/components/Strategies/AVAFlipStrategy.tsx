        ...
        <div className="space-y-12 animate-fade-in">
            ...
            <div className={`relative overflow-hidden rounded-3xl p-8 border ${theme === 'dark'
                ...
                <div className="relative flex flex-col md:flex-row gap-8 items-start">
                    <div className={`p-4 rounded-2xl ${theme === 'dark' ? 'bg-[#4E6E49]/10' : 'bg-[#4E6E49]/5'}`}>
                        <Timer className={`w-12 h-12 text-[#4E6E49]`} />
                    </div>
                    <div className="flex-1 space-y-4">
                        <div className="flex items-center gap-3">
                            <h2 className={`text-2xl md:text-3xl font-black ${headingColor}`}>ARCA FLIP-1S</h2>
                            <span className="px-3 py-1 rounded-full bg-[#4E6E49]/20 text-[#4E6E49] text-[10px] font-black uppercase tracking-widest border border-[#4E6E49]/20">Scalping</span>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className={`rounded-2xl p-6 border-l-8 ${theme === 'dark' ? 'bg-[#0b1015] border-[#4E6E49]/50' : 'bg-gray-50 border-[#4E6E49]/30'
                    ...
                    <Activity className="w-8 h-8 text-[#4E6E49] shrink-0" />
                ...
                <div className={`rounded-2xl p-6 border ${theme === 'dark' ? 'bg-[#4E6E49]/5 border-[#4E6E49]/20' : 'bg-[#4E6E49]/5 border-[#4E6E49]/20'
                    ...
                    <MousePointer2 className="w-8 h-8 text-[#4E6E49] shrink-0" />
                    <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                    { title: "Освоение", desc: "От 1 недели до месяца. Не сравнивайте свой путь с чужим.", icon: <Rocket className="w-5 h-5 text-[#4E6E49]" /> },
                    { title: "Потенциал", icon: <TrendingUp className="w-5 h-5 text-[#4E6E49]" />, desc: "Возможен выход на $1000/день через месяц практики." },
                    { title: "Тайминг", icon: <Clock className="w-5 h-5 text-[#4E6E49]" />, desc: "Сделки 1-5 сек. Важна концентрация, а не глубокий ресерч." }
                ].map((item, idx) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className={`p-4 rounded-xl border ${theme === 'dark' ? 'bg-white/5 border-white/10' : 'bg-gray-50 border-gray-200'}`}>
                                    <h5 className="text-xs font-bold uppercase mb-2 text-[#4E6E49]">Миграции Axiom</h5>
                                    <p className="text-xs text-gray-500 leading-relaxed">Jupiter Studio, Believe, Moonshot. Главное — открыть график до просадки.</p>
                                </div>
                                <div className={`p-4 rounded-xl border ${theme === 'dark' ? 'bg-white/5 border-white/10' : 'bg-gray-50 border-gray-200'}`}>
                                    <h5 className="text-xs font-bold uppercase mb-2 text-[#4E6E49]">Photon (Тренды)</h5>
                            ...
                            <div className="p-4 rounded-xl border border-l-4 border-[#4E6E49]/50 ${theme === 'dark' ? 'bg-[#4E6E49]/5' : 'bg-[#4E6E49]/5'}">
                    ...
                    >
                        <div className={`p-4 rounded-xl border border-l-4 border-[#4E6E49]/50 ${theme === 'dark' ? 'bg-[#4E6E49]/5' : 'bg-[#4E6E49]/5'}`}>
                            <p className="text-sm font-bold uppercase mb-2 tracking-widest text-[#4E6E49]">Резкая просадка</p>
                            ...
                            <div className="flex flex-col gap-2">
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-3 text-xs">
                                        <div className="w-5 h-5 rounded-full bg-[#4E6E49]/20 text-[#4E6E49] flex items-center justify-center font-bold text-[10px]">{i + 1}</div>
                                        {step}
                                    </div>
                                ))}
                            </div>
                            <p className="text-xs text-[#4E6E49] font-bold mt-2">Важно: Купить на просадке, а не после того, как график уже вернулся на хай.</p>
                        </div>
                    </StrategyStep>
                    ...
                    >
                        <div className={`p-4 rounded-xl border border-dashed ${theme === 'dark' ? 'border-[#4E6E49]/30' : 'border-[#4E6E49]/20'}`}>
                ...
                <div className="space-y-6">
                    ...
                    <div className={`rounded-2xl p-6 border ${theme === 'dark' ? 'bg-[#151a21]/80 border-white/5' : 'bg-white border-gray-100'
                        ...
                        <div className="flex items-center gap-3">
                            <Info className={`w-6 h-6 text-[#4E6E49]`} />
                            <h3 className={`text-lg font-black ${headingColor}`}>Экспресс-чек</h3>
                        </div>
                        <div className="space-y-3">
                            <div className="space-y-1 pb-2 border-b border-white/5">
                                <p className="text-[9px] font-black text-[#4E6E49] uppercase tracking-widest">Объёмы</p>
                                <p className="text-xs text-gray-500">За 5 мин — $50,000+. Серия зелёных свечей вверх.</p>
                            </div>
                            <div className="space-y-1 pb-2 border-b border-white/5">
                                <p className="text-[9px] font-black text-[#4E6E49] uppercase tracking-widest">Метрики</p>
                                <p className="text-xs text-gray-500">DEV {'<'} 2%. Топ-10 холдеров {'<'} 50%. Ликвидность {'>'} $20k.</p>
                            </div>
                            <div className="space-y-1 pb-2 border-b border-white/5">
                                <p className="text-[9px] font-black text-[#4E6E49] uppercase tracking-widest">Позиция</p>
                    ...
                    {/* Risk Management */}
                    <div className={`p-6 rounded-2xl border-2 border-dashed ${theme === 'dark' ? 'border-[#4E6E49]/30' : 'border-[#4E6E49]/20'} space-y-4`}>
                        <div className="flex items-center gap-3">
                            <ShieldAlert className="w-5 h-5 text-[#4E6E49]" />
            ...
            <div className={`rounded-2xl p-6 border-l-8 ${theme === 'dark' ? 'bg-[#0b1015] border-[#4E6E49]/50' : 'bg-gray-50 border-[#4E6E49]/30'
                ...
                <div className="flex gap-4 items-start">
                    <HelpCircle className="w-8 h-8 text-[#4E6E49] shrink-0" />
                    <div className="space-y-2">
