        ...
        <div className="space-y-12 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    ...
                    { title: "Стабильность", icon: <TrendingUp className="w-5 h-5 text-[#4E6E49]" />, desc: "Забираем повторяемую прибыль на умеренных сетапах." },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className={`rounded-2xl p-6 border ${theme === 'dark' ? 'bg-[#4E6E49]/5 border-[#4E6E49]/20' : 'bg-[#4E6E49]/5 border-[#4E6E49]/20'
                    ...
                    <ShieldAlert className="w-8 h-8 text-[#4E6E49] shrink-0" />
                    <div className="space-y-2">
                ...
                <div className="lg:col-span-2 space-y-4">
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4">
                                <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-white/5' : 'bg-gray-50'}`}>
                                    <Send className="w-5 h-5 text-[#4E6E49]" />
                                </div>
                                <div className="flex-1">
                    ...
                    >
                        <div className="space-y-4">
                            <div className={`p-4 rounded-xl border border-l-4 border-[#4E6E49]/50 ${theme === 'dark' ? 'bg-[#4E6E49]/5' : 'bg-[#4E6E49]/5'}`}>
                                <p className="text-sm font-bold text-[#4E6E49] uppercase tracking-widest mb-1">Правило входа</p>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['0.5', '0.618', '0.786'].map(level => (
                                    <div key={level} className={`px-4 py-2 rounded-lg border font-black text-sm ${theme === 'dark' ? 'bg-white/5 border-white/10 text-[#4E6E49]' : 'bg-[#4E6E49]/5 border-[#4E6E49]/20 text-[#4E6E49]'}`}>
                                        {level}
                                    </div>
                                ))}
                            </div>
